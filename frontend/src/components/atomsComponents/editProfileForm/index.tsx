		...
		<div className="w-full max-w-4xl mx-auto bg-background rounded-2xl shadow-xl border p-6 md:p-8">
			...
			<div className="mb-8">
				...
				<p className="text-muted-foreground mt-2.5 text-base">
					{currentStep === 1 && "Choose or upload your profile picture"}
					{currentStep === 2 && "Tell us about yourself"}
					{currentStep === 3 && "Select your role and interests"}
					{currentStep === 4 && "Connect your social profiles (optional)"}
				</p>
			</div>
				...
				{currentStep === 2 && (
					<>
						...
						<div className="space-y-7">
							...
							<div className="grid flex-1 gap-3">
								<Label htmlFor="handleName" className="text-sm font-semibold">
