  ...
  function handleDrop(e: React.DragEvent<HTMLDivElement>) {
    ...
    if (e.dataTransfer.files && e.dataTransfer.files[0]) {
      ...
      if (file.name.endsWith(".md")) {
        ...
        handleupload({ target: { files: fileList } } as React.ChangeEvent<HTMLInputElement>, saveContent);
        ...
        <div className="flex items-center justify-center border-1 flex-col gap-2">
          {uploadType == "file" ? (
            <div
              ...
              onDrop={handleDrop}
              onClick={handleClick}
              className={`relative m-3 border-2 h-70 max-w-80 w-full border-dashed rounded-xl p-6 flex flex-col items-center justify-center cursor-pointer transition ${dragActive ? "border-blue-500 bg-blue-50" : "border-gray-400"
                }`}
            >
              {dragActive ? (
                <div className="absolute inset-0 bg-blue-500/20 flex flex-col items-center justify-center rounded-xl pointer-events-none">
                  <UploadCloud size={40} className="text-blue-600 mb-2" />
                ...
                <>
                  ...
                  {!fileName ? (
                    <p className="text-sm text-gray-600 mb-2 text-center">
                      Drag & drop your <code>.md</code> file here <br /> or click to browse
                    </p>
                  ) : (
