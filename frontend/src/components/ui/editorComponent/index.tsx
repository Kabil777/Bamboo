...
import { useCollab } from "@/lib/hocuspocus";
...
export default function Editor() {
    ...
    const editorExtensions = React.useMemo(() => {
        if (!provider || !synced) return extensions;
    ...
    }, [provider, synced, collabUser.name, collabUser.color]);
                            ...
                            >
                                ...
                                <DialogContent className="sm:max-w-[425px]">
                                    ...
                                    <DialogDescription className="mb-5">
                                        Upload the current content as a blog
                                        post.
                                    </DialogDescription>
                                    <DialogFooter>
                                        <DialogClose asChild>
