                        ...
                        <div className="mt-5 sm:mt-6 space-y-3 sm:space-y-4">
                            ...
                            <div className="flex items-center justify-between gap-3">
                                <div className="flex items-center gap-2.5 min-w-0">
                                    <div className="size-8 shrink-0 rounded-full bg-muted border border-border/60 flex items-center justify-center text-xs font-bold text-muted-foreground">
                                        {(story.authorName || "B")[0].toUpperCase()}
                                    </div>
                                    <div className="min-w-0">
                                        <p className="text-[9px] uppercase tracking-[0.2em] text-muted-foreground/60 leading-none">
                                            Written by
                                        </p>
                                        <p className="mt-0.5 text-sm font-semibold text-foreground truncate leading-tight">
        ...
        <main className="w-full">
            <div className="mx-auto w-full md:max-w-6xl 2xl:max-w-[1400px] px-3 sm:px-5 lg:px-8">
                ...
                <div className="space-y-0 pt-6">
                    ...
                    {blogLoading ? (
                        <Skeleton className="h-[340px] sm:h-[380px] w-full rounded-[24px]" />
